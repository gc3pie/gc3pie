...
DESC="A4Mesh"
NAME="ggeosphere_web"
DIR="/home/sergio/dev/gc3pie/trunk/gc3pie/gc3apps/a4mesh"
DAEMON="${DIR}/${NAME}.py"
PIDFILE=/tmp/$NAME.pid
SCRIPTNAME=/etc/init.d/$NAME
SESSION_DIR="$DIR/test.web/sessions/"
A4MESH_CONFIG="$DIR/test.web/etc/a4mesh.cfg"
SESSION_NAME=`date +%Y%m%d`

# Configuration for deployment
# DESC="A4Mesh"
# NAME="ggeosphere_web"
# A4MESH_DIR="/opt/a4mesh/geosphere_web/bin"
# PATH=/sbin:/usr/sbin:/bin:/usr/bin:${A4MESH_DIR}/bin
# SESSION_DIR="${A4MESH_DIR}/sessions"
# A4MESH_CONFIG="${A4MESH_DIR}/etc/ggeosphere.cfg"
# SESSION_NAME="ggeosphere"
# DAEMON_ARGS="-c ${A4MESH_CONFIG} -vvvvv -s ${SESSION_DIR}/${SESSION_NAME} -C15"
# Enable GC3Pie virtualenv
# . ${A4MESH_DIR}/virtualenv/a4mesh/bin/activate

DAEMON_ARGS="-c ${A4MESH_CONFIG} -vvvvv -r localhost -s ${SESSION_DIR}/${SESSION_NAME} -C15"
...
# Enable GC3Pie virtualenv
. ~/virtualenvs/gc3pie-trunk/bin/activate
