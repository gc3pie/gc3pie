...
\end{python}
    ...
    \begin{column}{0.3\linewidth}
      \href{https://raw.githubusercontent.com/uzh/gc3pie/master/docs/programmers/tutorials/workflows/day1.py}{Download} this code into a file named \texttt{day1.py}
...
\begin{frame}[fragile]
  ...
  \begin{exercise*}[2.B]
    ...
    \+
    Edit the \texttt{day1.py} file: insert the code to define the
