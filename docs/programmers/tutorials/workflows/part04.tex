...
\begin{frame}[fragile]
  \begin{exercise*}[4.A]
    Write a \texttt{gasset.py} to read the two input arguments - 'parameters.csv' 
    and 'Matlab script' - and assign them respectively to ``parameters`` and ``mscript``
    variables.
  \end{exercise*}
\end{frame}
