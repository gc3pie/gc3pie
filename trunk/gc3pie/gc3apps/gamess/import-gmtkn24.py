    ...
    try:
        if 'import' == args[0]:
            ...
            for subset in subsets:
                ...
                if not os.path.exists(os.path.join(destdir, 'subsets', subset)):
                    os.mkdir(os.path.join(destdir, 'subsets', subset))
                ...
                for molecule in molecules:
                    destfile = os.path.join(destdir, 'subsets', subset, molecule + '.inp')
                ...
                refdata_csv = os.path.join(destdir, 'subsets', subset, 'refdata.csv')
                ...
                output = open(os.path.join(destdir, 'subsets', subset, 'index.mdwn'), 'w')
                output.write("""
