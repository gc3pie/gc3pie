...
class GridDriver(SequentialTaskCollection):
    ...
    :func:`task_constructor` to generate :class:`Application` instances to be
    executed in parallel. When all jobs are complete, the output 
    is analyzed with the user-supplied function :func:`target_fun`. This function 
