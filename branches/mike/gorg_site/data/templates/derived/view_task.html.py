...
_magic_number = 5
_modified_time = 1268754178.96557
_template_filename='/home/mmonroe/apps/gorg/gorg_site/gorg_site/templates/derived/view_task.html'
_template_uri='/derived/view_task.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n<p>Title: ')
        # SOURCE LINE 27
        __M_writer(escape(c.a_task.title))
        __M_writer(u'</p>\n<p>Author: ')
        # SOURCE LINE 28
        __M_writer(escape(c.a_task.author))
        __M_writer(u'</p>\n\n')
        # SOURCE LINE 30
        if len(c.paginator):
            # SOURCE LINE 31
