...
_magic_number = 5
_modified_time = 1270121287.3873971
_template_filename='/home/mmonroe/apps/gorg/gorg_site/gorg_site/templates/derived/view_job.html'
_template_uri='/derived/view_job.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n')
        # SOURCE LINE 6
        __M_writer(u'<p>Author: ')
        __M_writer(escape(c.a_job.author))
        __M_writer(u'</p>\n<p>Attachments: </p>\n<table>\n')
        # SOURCE LINE 9
        for attachment in c.a_job.attachments:
            # SOURCE LINE 10
            __M_writer(u'                <tr>\n                <td>')
            # SOURCE LINE 11
            ...
            __M_writer(escape(h.link_to(
	                ...
	                h.url_for(
	                    ...
	                    action='view_job_attachment',
	                    id=unicode(c.a_job.id))+
